        ...
        <section class="section">
            <div class="d-flex align-items-stretch flex-wrap">
                ...
                <div class="col-lg-8 col-12 order-lg-2 min-vh-100 background-walk-y position-relative overlay-gradient-bottom order-1"
                    data-background="{{ asset('img/unsplash/ach-login-bg.jpg') }}">
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            <div class="mb-5 pb-3">
                                <h1 class="display-4 font-weight-bold mb-2">Good Day</h1>
                                <h5 class="font-weight-normal text-muted-transparent">Jatibening, Bekasi</h5>
                            </div>
                            Photo by <a class="text-light bb"
                                target="_blank"
                                href="https://instagram.com/p/C0oYltLxr7V/?igsh=MTY5MnBjbmZ2ZHJsZQ==">Acharne Coffee</a> on <a
                                class="text-light bb"
                                target="_blank"
